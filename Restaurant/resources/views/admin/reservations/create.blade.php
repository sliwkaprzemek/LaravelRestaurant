    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex m-2 p-2">
                <a href="{{route('admin.reservations.index')}}" class="px-4 py-2 bg-gray-500 hover:bg-gray-700 rounded-lg text-white">Powrót</a>
            </div>
              ...
              <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                  <form method="POST" action="{{ route('admin.reservations.store') }}">
                      ...
                      <div class="sm:col-span-6">
                          <label for="first_name" class="block text-sm font-medium text-gray-700"> Imie </label>
                          <div class="mt-1">
                      ...
                      <div class="sm:col-span-6">
                          <label for="res_date" class="block text-sm font-medium text-gray-700"> Data rezerwacji
                          </label>
                          <div class="mt-1">
